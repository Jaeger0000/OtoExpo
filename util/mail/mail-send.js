...
exports.sendAdminMailForget = (email,token)=> {
  const mailOptions = {
      from: 'otoexpo.destek@gmail.com', // Sender address
      to: email, // List of recipients
      subject: 'Admin Reset Your Password', // Subject line
      text: 'Admin Reset Your Password', // Plain text body
      html: `<!DOCTYPE html>
      <html lang="en">
      <head>
        <meta charset="UTF-8">
      ...
      <body>
        <div class="container">
          ...
          <p>You recently requested to reset your password. To reset your password, click the button below:</p>
           <br>
          <p><a class="btn" href="https://www.otoexpo.shop/admin-reset-password/${token}">Reset Password</a></p>
          <br>
          <p>If you did not request a password reset, please ignore this email.</p>
          <p>Thank you,</p><h3>OtoExpo</h3>
        </div>
