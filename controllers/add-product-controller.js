...
exports.getAddProductCar = (req, res, next) => {
    ...
    res.render('UserPages/add-product-pages/add-product-car',{path:'/add-product',error: errormsg});
}
...
exports.getAddProductMotorcycle = (req, res, next) => {
    ...
    res.render('UserPages/add-product-pages/add-product-motorcycle',{path:'/add-product',error: errormsg});
}
